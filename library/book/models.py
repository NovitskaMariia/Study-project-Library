...
class Book(models.Model):
    ...
    year_of_publish = models.IntegerField(default=0)
    date_of_issue = models.DateTimeField(default=None, null=True, blank=True)
    ...
    @staticmethod
    def create(name, description, count=10, authors=None, year_of_publish=0):
        """
        param name: Describes name of the book
        type name: str max_length=128
        param description: Describes description of the book
